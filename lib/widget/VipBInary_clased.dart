...
class VipBinaryClosedSignal extends StatelessWidget {
  CollectionReference signal =
      FirebaseFirestore.instance.collection('VipBinaryFreeSignal');
  @override
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                            ...
                            child: Container(
                                child: Text(
                                  "Time - "+post.slPrice,style: TextStyle(
                                    fontSize: 20
                                ),))),
                        Positioned(
                            bottom: 10,
                            ...
                            child: Container(
                                child: Text(
                                  "Duration - "+post.tpPrice,style: TextStyle(
                                    fontSize: 20
                                ),))),
                        Positioned(
                            left: 10,
